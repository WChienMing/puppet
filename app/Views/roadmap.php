    ...
    <section id="roadmap" class="section-roadmap">
        ...
        <div class="section-roadmap__container container">
            <div class="section-roadmap__wrapper">
                ...
                <div class="section-roadmap__button wow animate__animated animate__pulse" data-wow-delay="0.7s"><a class="btn btn-animate btn-animate--primary" href="#" style="opacity: 1; visibility: inherit; overflow: visible">
