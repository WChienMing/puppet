<main class="main m-0 p-0">
    <section class="section-hero">
        <div class="section-hero__container container" style="position: relative; text-align: center;">
            <img src="public/img/back_image.svg" alt="" class="nft1_img">
    ...
    <section class="section_bar_bottom">
        <div class="row">
            <h3 class="nft-h1 m-0" style="text-align: center;">Component</h3>
        </div>
    </section>
